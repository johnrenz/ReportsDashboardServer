...
const searchUsageByWebsite = async (req, res) => {
        let parameters = {
        ...
        const cacheKey = `UsageByWebsite:SearchBy=${parameters.SearchBy},
        ...
        if (useCaching) {
            ...
            if (cacheActivity) {
                ...
                dbOperation.getUsageByWebsite(parameters).then(eResult => {
